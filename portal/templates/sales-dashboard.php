    ...
    <?php elseif($active_tab==='call-queue'): ?>
        ...
        <div class="six-card" style="margin-bottom:12px">
            <div class="six-card-body" style="display:flex;align-items:center;gap:20px;flex-wrap:wrap">
                <div style="font-family:var(--font-head);font-size:20px;font-weight:800;color:var(--danger);min-width:28px;text-align:center"><?php echo $i+1;?></div>
                ...
                <div style="text-align:right">
                    <div style="font-size:28px;font-weight:800;color:var(--danger);font-family:var(--font-head)"><?php echo $lead['score'];?></div>
