...
function six_service_pages() {
    $pages = array(
        ...
        'ppc-google-ads-management-toronto' => array(
            ...
            'sections' => array(
                array( 'icon' => 'rocket', 'image' => SIX_MK_URL . 'assets/img/gads-strategic-management.png', 'title' => 'Maximize Your ROI with Strategic Google Ads Management', 'paras' => array(
                ...
                array( 'icon' => 'globe', 'image' => SIX_MK_URL . 'assets/img/gads-geo-targeting.png', 'title' => 'Unlock Precision Targeting with GEO Google Ads Marketing Strategy', 'paras' => array(
            ...
            'pricing' => array(
                ...
                'calculator'  => true,
                'calc_heading'=> 'Find out your monthly management cost',
                'cta'         => 'Talk to PPC Expert',
                'fees' => array(
                    array( 'label' => 'One Time Setup Fee:', 'note' => 'Onboarding Fee: $1500. New Google Ads account pay only $999.' ),
                    array( 'label' => 'Our Management Fee:', 'note' => 'New Google Ads accounts pay $0 for the first 2 Months. We want to build trust by showing the results before taking your money. After the first 2 months, our management fee is $799 per month or 15% of monthly Google Ads budget, whichever is greater. $0 for 2 months apply on new Google Ads accounts only.' ),
                ),
                'included_heading' => "What's Included",
                'included' => array(
                    array( 'Platforms',                  'Google Ads' ),
                    array( 'Keyword Research',           'Yes' ),
                    array( 'Competitor Research',        'Yes' ),
                    array( 'Review Calls',               'Monthly' ),
                    array( 'Account Access',             'Manager' ),
                    array( 'Reporting Dashboard',        'Yes' ),
                    array( 'Google Analytics',           'Yes' ),
                    array( 'Goal Setting',               'Yes' ),
                    array( 'Click Fraud Protection',     'Yes' ),
                    array( 'Call & Conversion Tracking', 'Yes' ),
                    array( 'Remarketing & Display Ads',  'Yes' ),
                ),
            ),
    ...
    $dm['sections'] = array(
        array( 'icon' => 'rocket', 'image' => SIX_MK_URL . 'assets/img/gads-strategic-management.png', 'title' => 'Maximize Your ROI with Strategic Digital Marketing Management', 'paras' => array(
            "Running a search marketing campaign on Google, regardless of your business size, can quickly become costly without a solid strategy in place. Google Ads' broad targeting capabilities often lead to overspending on irrelevant keywords, resulting in wasted budget and minimal leads.",
        ...
        array( 'icon' => 'globe', 'image' => SIX_MK_URL . 'assets/img/gads-geo-targeting.png', 'title' => 'Unlock Precision Targeting with GEO Digital Marketing Strategy', 'paras' => array(
